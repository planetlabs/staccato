...
public class DefaultSchemaService implements SchemaService {
    ...
    private void init() {
        ...
        if (null != collections && !collections.isEmpty()) {
            ...
            try {
                Resource catalogResource = new UrlResource("https://raw.githubusercontent.com/radiantearth/stac-spec/v0.9.0-rc2/catalog-spec/json-schema/catalog.json");
                Resource collectionResource = new UrlResource("https://raw.githubusercontent.com/radiantearth/stac-spec/v0.9.0-rc2/collection-spec/json-schema/collection.json");
                Resource itemResource = new UrlResource("https://raw.githubusercontent.com/radiantearth/stac-spec/v0.9.0-rc2/item-spec/json-schema/item.json");
